...
class WaterScan {
    private static final LongOpenHashSet WATER = new LongOpenHashSet(32768);
    ...
    protected static void scan(MinecraftClient client) {
    ...
    protected static void init() {
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            while (UI.TOGGLE_AURA_KEY.wasPressed()) {
                UI.toggle_on_off();
            }
